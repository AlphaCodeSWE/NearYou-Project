...
def main():
    ...
    dashboard_template_path = os.path.join(base_dir, "provisioning/dashboards/near_you_dashboard.json")
    assembled_dashboard_path = os.path.join(base_dir, "provisioning/dashboards/near_you_dashboard_assembled.json")
    ...
    panel_files = {
        ...
        "${PANEL_STAT_EVENTS}": "stat_events.json",
